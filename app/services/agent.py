...
SHOP_CONFIG = {
    "default": {
        ...
        "prices": {
            ...
            "데이카약 (2시간 체험, 정원 40명)": "1인 3만원 (카약 1대에 2인 탑승 가능, 1인 탑승도 가능, 가격 동일)",
            "선셋카약 (2시간 체험, 정원 40명)": "1인 3만원 (카약 1대에 2인 탑승 가능, 1인 탑승도 가능, 가격 동일)",
...
[카약 특이사항 - 중요]
- 카약 1대에 2명 탑승 가능 (2인 1카약 구조)
- 혼자서도 탑승 가능하며 가격은 동일 (1인 3만원)
- 예약은 인당 1개씩: 2명이면 예약 2개, 1명이면 예약 1개
- 손님이 "카약 2명이면 예약 몇 개요?" 물으면 → "예약은 인당 1개씩이라 2개 해주시면 됩니다. 카약 1대에 2명이 함께 타실 수 있고, 혼자 타셔도 가격은 동일하게 1인 3만원이에요 😊"
